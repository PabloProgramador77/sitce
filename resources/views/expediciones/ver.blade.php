...
<div class="content-wrapper" style="min-height: 1302.13px;">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Ver expedición</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{url('/')}}">Inicio</a></li>
                        <li class="breadcrumb-item"><a href="{{url('/expediciones')}}">Expediciones</a></li>
                        <li class="breadcrumb-item active">Ver Expedición</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title col-md-10">Información de expedición.</h3>
                </div>
                <form role="form">
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <a href="{{url('/')}}/expediciones" type="button" class="btn btn-secondary btn-block"><b>Regresar</b></a>
                    </div>
