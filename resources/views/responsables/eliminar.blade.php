        ...
        <div class="col-md-8">
            <div class="card card-secondary">
                <div class="card-header">
                    <h3 class="card-title">Los datos y archivos no podrán ser recuperados, confirma los datos</h3>
                </div>
                <form role="form">
                    <div class="card-body">
                        <div class="form-group">
                            <label for="nombre">*Nombre</label>
                            <input type="text" class="form-control" readonly="true" id="nombre" name="nombre" placeholder="Nombre(s)" value="{{$responsable->nombre}}">
                        </div>
                        <div class="form-group">
                            <label for="apellido">*Primer Apellido</label>
                            <input type="text" class="form-control" readonly="true" id="apellido" name="apellido" placeholder="Apellido paterno" value="{{$responsable->primerApellido}}">
                        </div>
                        <div class="form-group">
                            <label for="apellido2">Segundo Apellido</label>
                            <input type="text" class="form-control" readonly="true" id="apellido2" name="apellido2" placeholder="Apellido materno" value="{{$responsable->segundoApellido}}">
                        </div>
                        <div class="form-group">
                            <label for="curp">* CURP</label>
                            <input type="text" class="form-control" readonly="true" id="curp" name="curp" placeholder="CURP" value="{{$responsable->curp}}">
                        </div>
                        <div class="form-group">
                            <label>* Cargo</label>
                            <select class="custom-select" id="cargo" name="cargo" readonly="true">
...
<script src="{{asset('js/responsable/eliminar.js')}}" type="text/javascript"></script>
@endsection