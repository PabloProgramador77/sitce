...
<div class="content-wrapper" style="min-height: 1302.13px;">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Datos de carrera</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                        <li class="breadcrumb-item"><a href="{{url('/carreras')}}">Carreras</a></li>
                        <li class="breadcrumb-item active">Datos de carrera</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-8">
            <div class="card card-secondary">
                <div class="card-header">
                    <h3 class="card-title">Alumnos inscritos en la carrera</h3>
                </div>
                <div class="card-body">
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Aguilar</td>
                                <td>
                                    <a href="{{url('/alumnos/ver')}}" type="button" class="btn btn-primary" title="Información de carrera">
            ...
            <div class="card card-secondary">
                ...
                <div class="card-body box-profile">
                    ...
                    <li class="list-group-item">
                        ...
                        <li class="list-group-item">
                            <b>ID</b><a class="float-right">{{$carrera->idCarrera}}</a>
                        </li>
                        <li class="list-group-item">
